...
import { Arrow, LaunchPadPrize, Techfeudprize, RegisterButton, Hackbuildprize, Ctfprize } from './svg';
...
// Define the interface for a single event object
interface EventData {
    image: string;
    title: string;
    description: string;
    date: string;
    prizeComponent: React.ReactElement | null;
...
const Events = () => {
    ...
    // Explicitly type the events array using the EventData interface
    const events: EventData[] = [
        ...
        },
        {
            ...
            prizeComponent: null, // prizeComponent can be null
