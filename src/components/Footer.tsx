...
const Footer = () => {
  ...
  return (
    <footer className="w-full text-white bg-transparent font-[Wadik] relative overflow-hidden">
      {/* Folder Tab Design with outer shadow */}
      <div className="relative w-full"
        ...
        <div className="flex justify-center">
          <div className="relative z-20 w-fit max-w-[calc(100%-40px)] sm:max-w-md md:max-w-lg lg:max-w-xl xl:max-w-2xl">
            <div className="bg-gradient-to-b from-[#444] to-[#333] relative py-3 px-8 md:px-16 md:py-5"
              ...
              {/* Tab glow effect */}
              <div className="absolute inset-0 bg-gradient-to-b from-[#A1E9A5]/10 to-transparent"
                   style={{
                     // Match border-radius of the parent for glow effect
                     borderTopLeftRadius: 'clamp(8px, 2vw, 16px)',
                     borderTopRightRadius: 'clamp(8px, 2vw, 16px)'
                   }}></div>
            </div>
        ...
        <div className="bg-gradient-to-b font-[Wadik] from-[#333] to-[#111] relative rounded-t-3xl">
          ...
          <div className="py-10 px-4 md:py-16 md:px-10 relative z-10">
            {/* Decorative blurred circle with floating animation */}
            <div className="absolute -bottom-24 -right-24 w-72 h-72 bg-[#A1E9A5]/10 rounded-full blur-3xl z-0 pointer-events-none animate-pulse"
                 style={{
                   animation: 'float 6s ease-in-out infinite, pulse 4s ease-in-out infinite'
                 }} />

            {/* Green Halo Gradient from bottom with subtle movement */}
            <div className="absolute bottom-0 left-0 w-full h-1/2 bg-gradient-to-t from-[#14532D]/90 to-transparent z-0 pointer-events-none transform transition-transform duration-1000"
                 style={{
                   animation: 'gradient-shift 8s ease-in-out infinite'
                 }} />
            <div className="absolute bottom-0 left-0 w-full h-2/5 bg-gradient-to-t from-[#A1E9A5]/20 to-transparent z-0 pointer-events-none"
                 style={{
                   animation: 'gradient-shift 10s ease-in-out infinite reverse'
                 }} />
            <div className="absolute bottom-0 left-0 w-full h-1/3 bg-gradient-to-t from-[#A1E9A5]/10 to-transparent z-0 pointer-events-none"
                 style={{
            ...
            <div className="relative z-10 max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              {/* Social + Slogan with slide-in from right */}
              <div className={`flex flex-col items-end justify-center space-y-6 mt-8 md:mt-0 transform transition-all duration-1000 delay-200 ${
                isVisible ? 'translate-x-0 opacity-100' : 'translate-x-full opacity-0'
              }`}>
            ...
            {/* Copyright Notice with fade-in */}
            <div className={`mt-10 pt-4 font-[GoodTiming] text-center lg:text-right text-xs md:text-sm text-gray-400 border-t border-[#333] transition-all duration-1000 delay-1000 hover:text-gray-200 ${
